...
class SerializationWarningTest : public testing::Test {
 ...
 protected:
  ...
  void TestWarning(StructPtr<T> obj,
                   mdl::internal::ValidationError expected_warning) {
  ...
  void TestStructWarningImpl(TPtr obj,
                             mdl::internal::ValidationError expected_warning) {
    mdl::internal::FixedBufferForTesting buf(GetSerializedSize_(*obj));
...
TEST_F(SerializationWarningTest, HandleInStruct) {
  ...
  TestWarning(test_struct.Pass(), mdl::internal::ValidationError::NONE);
}
...
TEST_F(SerializationWarningTest, StructInStruct) {
  ...
  TestWarning(test_struct.Pass(),
              mdl::internal::ValidationError::UNEXPECTED_NULL_POINTER);
...
TEST_F(SerializationWarningTest, FixedArrayOfStructsInStruct) {
  ...
  TestWarning(test_struct.Pass(),
              mdl::internal::ValidationError::UNEXPECTED_ARRAY_HEADER);
...
TEST_F(SerializationWarningTest, ArrayOfArraysOfHandles) {
  ...
  TestArrayWarning(test_array.Pass(), mdl::internal::ValidationError::NONE,
                   &validate_params_0);
