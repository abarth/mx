...
TEST_F(StructSerializationAPITest, GetSerializedSize) {
  ...
  handle_struct.array_h = mdl::Array<mdl::ScopedMessagePipeHandle>::New(0);
  ...
  handle_struct.array_h = mdl::Array<mdl::ScopedMessagePipeHandle>::New(1);
...
TEST_F(StructSerializationAPITest, HandlesSerialization) {
...

  {
    ...
    HandleStruct handle_struct;
    handle_struct.array_h = Array<mdl::ScopedMessagePipeHandle>::New(1);
  ...
  // We shouldn't be able to serialize a valid handle.
  {
    ...
    handle_struct.array_h = Array<mdl::ScopedMessagePipeHandle>::New(0);
